#!/usr/bin/env python3
"""
Recupero codici sconto Myprotein da shopilo.it
Sursa: https://shopilo.it/negozi/myprotein.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/myprotein.it"
STORE_NAME = "Myprotein"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Myprotein da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-myprotein)"
    }
    try:
